ROC_ligne = function(x,m,n,cat0,cat1,y)
    {
    Norm = scale(x) # La normalisation. Voir ce que ça donne si les valeurs de x sont toute égales. 
...
#' 
#' Import your data, provied a 
#' @param mane_data : The name of your database 
#' @param a : The number of descriptives collumns. 
#' @param m : The number of collumns from 
#' @param  cat0 : Name of the first categorie
#' @param cat1 :
#' @return : blablabla
#' @export
rast = function(name_data,a,m,n,cat0,cat1,y='sorted', nom_output = "ROC_table.xls")
    {  # rast : ROC analysis sorted table
